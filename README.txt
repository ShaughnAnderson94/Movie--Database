...
In the movie database project we were given a set of Wes Anderson movies and some details about them and then asked to make a website that helped users interact with them.
